...
const Register: React.FC = () => {
    ...
    const RegisterSchema = yup.object({
        ...
        password: yup.string().matches(/^(?=.*[A-Z])(?=.*\d)(?=.*[\W_])[A-Za-z\d\W_]{6,}$/, { message: "Password must have at least 6 characters, one symbol, one number, and one uppeSOSse letter." }).label("Password")
    })
    const {
        register,
        handleSubmit,
    ...
    return (
        <div className='w-full flex flex-col items-center pt-[8vh] min-h-screen'>
            ...
            <div className='flex flex-col rounded-xl border border-slate-200 p-10 w-11/12 msm:w-[80%] sm:w-[70%] md:w-[50%] mlg:w-[40%] lg:w-[35%] 2xl:w-[28%] bg-white items-center'>
                ...
                <span className='text-2xl my-1'> SOS LMS</span>
